          ...
          <form action="{{ route('routine_exercises.store', $routine->id) }}" method="POST">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="category" name="category" maxlength="255" value="{{ old('category') }}">
              </div>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="difficulty_level" name="difficulty_level" required>
                  ...
                  <option value="medium" {{ old('difficulty_level') == 'medium' ? 'selected' : '' }}>Medio</option>
        ...
        <div class="card h-100 shadow-sm">
          ...
          <div class="card-body">
            ...
            <ul class="list-group list-group-flush mb-3">
              ...
              <li class="list-group-item"><strong>Dificultad:</strong> {{ ucfirst($exercise->difficulty_level) }}</li>
              <li class="list-group-item"><strong>Categoría:</strong> {{ $exercise->category ?? '-' }}</li>
            </ul>
